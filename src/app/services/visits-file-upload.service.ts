...
export class VisitsFileUploadService {
  ...
  private basePath = '/visits_uploads';
  ...
  public saveFileData(fileUpload: FileUpload) { 
    ...
    return this.db.collection('visits_uploads').add(data).then(e=>{
      return e.id;
    });
  }
  getFiles(): any { 
    this.uploadsCollection = this.db.collection('visits_uploads', ref => ref.orderBy('uploaded'));
  ...
  private deleteFileDatabase(key: string): Promise<void> { 
    return  this.db.doc('visits_uploads/' + key).delete();
  }
