...
export class RecreationFileUploadService {
  ...
  private saveFileData(fileUpload: FileUpload): void { 
    ...
    this.db.collection('recreation_uploads').add(data);
  }
  getFiles(): any { 
    this.uploadsCollection = this.db.collection('recreation_uploads', ref => ref.orderBy('uploaded'));
  ...
  private deleteFileDatabase(key: string): Promise<void> { 
    return  this.db.doc('recreation_uploads/' + key).delete();
  }
